...
let cateGoryObj = {
    ...
    'Leadership':['Leadership 1','Leadership 2','Leadership 3','Leadership 4','Leadership 5','Leadership 6','Leadership 7','Leadership 8'],
    'Information Technology':['Information Technology 1','Information Technology 2','Information Technology 3','Information Technology 4','Information Technology 5','Information Technology 6','Information Technology 7','Information Technology 8'],
...
getInitialState() {
    ...
    delete cateGoryObj[userJobFunction];
    let keys = Object.keys(cateGoryObj);
    return {
        mouserHover:false,
        subCateGory:cateGoryObj[keys[0]],
        category:cateGoryObj,
        selected:{},
        userClickedCat:keys[0]
    }
},
componentWillMount() {
    ss.use();
    ...
    return (
        <div className="QRZT_BasicModal" onClick={this.props.close}>
            <div className="ModalWrap">
                ...
                <center>
                    <p className="heading">Cross-Functional Areas of Interest</p>
                </center>
                <section className="MainContent">
